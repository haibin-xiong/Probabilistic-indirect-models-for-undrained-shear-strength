...
for i in range(4):
    for idx, feature in enumerate(features):
        ...
        sns.histplot(
            mice_data_i[feature], bins=bins, kde=False,
            fill=False, ax=ax,
            color='red', edgecolor='red', linewidth=5,
...
output_image_path = os.path.join(folder_path.parent, 'results', 'Comparison_His_MICE.png')
