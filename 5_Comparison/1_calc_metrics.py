...
for j in range(5):
    # MHA-PNN
    mn_df = pd.read_excel(folder.parent/'4_MHA_PNN'/'ext_predictions_MHA.xlsx', sheet_name=f"fold_{j + 1}")
    mice_df = pd.read_excel(folder.parent/'4_MHA_PNN'/'mice_predictions_MHA.xlsx', sheet_name=f"fold_{j + 1}")
    mf_df = pd.read_excel(folder.parent/'4_MHA_PNN'/'mf_predictions_MHA.xlsx', sheet_name=f"fold_{j + 1}")
    ...
    # XGBoost
    ori_df = pd.read_excel(folder.parent/'3_PXGB'/'ori_predictions_xgb.xlsx', sheet_name=f"fold_{j + 1}")
    ext_df = pd.read_excel(folder.parent/'3_PXGB'/'ext_predictions_xgb.xlsx', sheet_name=f"fold_{j + 1}")
    mice_xgb_df = pd.read_excel(folder.parent/'3_PXGB'/'mice_predictions_xgb.xlsx', sheet_name=f"fold_{j + 1}")
    mf_xgb_df = pd.read_excel(folder.parent/'3_PXGB'/'mf_predictions_xgb.xlsx', sheet_name=f"fold_{j + 1}")
